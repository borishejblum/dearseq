...
output:
  rmarkdown::html_vignette:
    ...
    toc: yes
vignette: >
  %\VignetteIndexEntry{User guide to the `dearseq` R package} 
...
For more details, check the article from *Berry  et al., 2010* [here](https://pmc.ncbi.nlm.nih.gov/articles/PMC3492754/).
...
library(readxl)
# library(rio)
# url_london <- GEOquery::getGEOSuppFiles('GSE107991', 
#                                          filter_regex="edgeR_normalized_Berry_London", 
#                                          fetch_files = FALSE)$url[1]
